...
<script>
    ...
    function getkabkota() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/getkab_distributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
    ...
    function getkecamatan() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/getkec_distributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
    ...
    function getkelurahan() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/getkel_distributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
    ...
    function getpenjual() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/get_distributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form-order').submit(function(event) {
            ...
            $('#btn02').show();
            $.ajax({
                    url: '<?php echo site_url('postdata/user_post/invoice/agen_order') ?>',
                    type: 'post',
                    dataType: 'json',
