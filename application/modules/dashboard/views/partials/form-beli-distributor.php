...
<script>
    ...
    function getkabkota() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/getkab_grdistributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
    ...
    function getkecamatan() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/getkec_grdistributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
    ...
    function getkelurahan() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/getkel_grdistributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
    ...
    function getpenjual() {
        ...
        $.ajax({
            url: '<?php echo site_url('getdata/user_get/getdaerah/get_grdistributor') ?>',
            type: 'GET',
            dataType: 'json',
            data: {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form-order').submit(function(event) {
            ...
            $('#btn02').show();
            $.ajax({
                    url: '<?php echo site_url('postdata/user_post/invoice/distributor_order') ?>',
                    type: 'post',
                    dataType: 'json',
