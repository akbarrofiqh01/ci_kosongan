            ...
            <div class="col col-login mx-auto mt-7">
                <div class="text-center">
                    <a href="<?php echo site_url('') ?>" title="SISPENJU">
                        <img src="<?php echo base_url('assets/logooo.png') ?>" class="header-brand-img" alt="LOGO" style="max-width: 300px;">
                    </a>
                </div>
            </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    ...
                                    <div class="container-login100-form-btn">
                                        <button type="submit" class="login100-form-btn btn-green" id="btn01">Login</button>
                                        <button type="submit" class="login100-form-btn btn-green" disabled id="btn02">Process</button>
                                    </div>
                                    <!-- <div class="text-center pt-3">
                                        <p class="text-dark mb-0">Belum Menjadi Member?<a href="<?php //echo site_url('signup') 
                                                                                                ?>" class="text-primary ms-1" title="DAFTAR">DAFTAR</a></p>
                                    </div> -->
                                </div>
                            </div>
                        </div>
