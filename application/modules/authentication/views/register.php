...
<div class="login-img">
	<div id="global-loader">
		<img src="<?php echo base_url('assets/backend/images/loader.svg') ?>" class="loader-img" alt="Loader">
	</div>
	<div class="page">
		<div class="">
			<div class="col col-login mx-auto mt-7">
				<div class="text-center">
					<a href="<?php echo site_url('') ?>" title="SISPENJU">
						<img src="<?php echo base_url('assets/logo-white.png') ?>" class="header-brand-img" alt="LOGO" style="max-width: 380px;">
					</a>
				</div>
			</div>
						...
						<div class="panel-body tabs-menu-body p-0 pt-5">
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<div class="form-group">
										<label for="">Referral Kode <small>(Optional)</small></label>
										<div class="input-group">
									...
									<div class="mt-5">
										...
										<div class="wrap-input100 validate-input input-group" id="Password-toggle">
											...
											<input name="user_password" class="input100 border-start-0 form-control ms-0" type="password" placeholder="Password" autocomplete="off">
										</div>
									</div>
									<div class="container-login100-form-btn">
										<button type="submit" class="login100-form-btn btn-danger" id="btn01">Daftar Sekarang</button>
										<button type="submit" class="login100-form-btn btn-danger" disabled id="btn02">Proses Mendaftar</button>
									</div>
